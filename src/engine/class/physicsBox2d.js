...
function PhysicsBox2d(properties) {
...
PhysicsBox2d.prototype.initDebug = function() {
	// setup debug draw
...
PhysicsBox2d.prototype.create = function(collision) {
...
PhysicsBox2d.prototype.createRect = function(x, y, width, height, collision) {
...
PhysicsBox2d.prototype.setBody = function(collision) {
...
PhysicsBox2d.prototype.createFixture = function(offsetX, offsetY, width, height, collision, body) {
	collision = collision || {};
...
PhysicsBox2d.prototype.moveShape = function(shape, x, y) {
...
PhysicsBox2d.prototype.setFixture = function(collision) {
	//this.fixDef = new Box2D.Dynamics.b2FixtureDef;
...
PhysicsBox2d.prototype.createListener = function(beginContact, endContact, preSolve, postSolve) {
...
PhysicsBox2d.prototype.getListener = function() {
    if (!this.listener) {
        this.createListener();
    }
	return this.listener;
...
PhysicsBox2d.prototype.removetListener = function() {
...
PhysicsBox2d.prototype.createCircle = function() {
...
PhysicsBox2d.prototype.beginContact = function(contact) {
	var data = null;
...
PhysicsBox2d.prototype.endContact = function(contact) {
	var data = null;
	data = contact.GetFixtureA().GetBody().GetUserData();
	if (data && data.entity && data.entity.collision) {
...
PhysicsBox2d.prototype.preSolve = function(contact, old) {
	var data = null;
	data = contact.GetFixtureA().GetBody().GetUserData();
	if (data && data.entity && data.entity.collision) {
...
PhysicsBox2d.prototype.postSolve = function(contact, impulse) {
	var data = null;
	data = contact.GetFixtureA().GetBody().GetUserData();
	if (data && data.entity && data.entity.collision) {
...
PhysicsBox2d.prototype.setFriction = function(body, friction, fixture) {
    if (!fixture) {
...
PhysicsBox2d.prototype.setDensity = function(body, density, fixture) {
    if (!fixture) {
        var fixture = body.GetFixtureList();
        while (fixture) {
...
PhysicsBox2d.prototype.getLinearVelocity = function(body) {
    return body.GetLinearVelocity();
};


PhysicsBox2d.prototype.setLinearVelocity = function(body, vel) {
    return body.SetLinearVelocity(vel);
};


PhysicsBox2d.prototype.vec2 = function(x, y) {
	return new Box2D.Common.Math.b2Vec2(x, y);
};


PhysicsBox2d.prototype.applyLinearImpulse = function(body, degrees, power) {
...
PhysicsBox2d.prototype.applyImpulse = function(body, degrees, power) {
...
PhysicsBox2d.prototype.applyLinearForce = function(body, degrees, power) {
...
PhysicsBox2d.prototype.applyForce = function(body, degrees, power) {
...
PhysicsBox2d.prototype.getCenter = function(body) {
	return body.GetWorldCenter();
};


PhysicsBox2d.prototype.getPosition = function(body) {
	return body.GetPosition();
};


PhysicsBox2d.prototype.getAngleDegree = function(body) {
    return yespix.radianToDegree(body.GetAngle());
};


PhysicsBox2d.prototype.getAngleRad = function(body) {
    return body.GetAngle();
};


PhysicsBox2d.prototype.getTouchList = function(body, fixture) {
...
PhysicsBox2d.prototype.getUserData = function(object) {
...
PhysicsBox2d.prototype.setUserData = function(data, object) {
    object = object || this.body;
...
yespix.defineClass('physicsBox2d', PhysicsBox2d);
